...
import net.mcreator.zeldaswordskillreborn.procedures.UseHylianShieldProcedure;
...
public class HylianShieldItem extends Item {
	...
	public void releaseUsing(ItemStack itemstack, Level world, LivingEntity entityLiving, int timeLeft) {
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (UseHylianShieldProcedure.execute()) {
				HylianShieldEntity entityarrow = HylianShieldEntity.shoot(world, entity, world.getRandom(), 1f, 5, 5);
