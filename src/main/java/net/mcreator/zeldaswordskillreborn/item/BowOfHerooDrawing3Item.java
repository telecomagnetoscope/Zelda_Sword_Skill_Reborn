...
public class BowOfHerooDrawing3Item extends Item {
	public BowOfHerooDrawing3Item() {
		...
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				...
				if (entity.getAbilities().instabuild || stack != ItemStack.EMPTY) {
					BowOfHerooDrawing3Entity entityarrow = BowOfHerooDrawing3Entity.shoot(world, entity, world.getRandom(), 1.2f, 9, 2);
