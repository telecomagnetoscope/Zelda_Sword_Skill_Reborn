...
import net.mcreator.zeldaswordskillreborn.item.inventory.RupeeWalletInventoryCapability;
...
public class RupeeWalletItem extends Item {
	public RupeeWalletItem() {
		super(new Item.Properties().tab(ZeldaSwordSkillRebornModTabs.TAB_ZSS_ITEM).stacksTo(1).fireResistant().rarity(Rarity.COMMON));
	}
		...
		if (entity instanceof ServerPlayer serverPlayer) {
			NetworkHooks.openScreen(serverPlayer, new MenuProvider() {
				...
				public Component getDisplayName() {
					return Component.literal("Rupee Wallet");
				}
	...
	public ICapabilityProvider initCapabilities(ItemStack stack, @Nullable CompoundTag compound) {
		return new RupeeWalletInventoryCapability();
	}
