...
import net.mcreator.zeldaswordskillreborn.procedures.UseMirrorShieldProcedure;
...
public class MirrorShieldItem extends Item {
	public MirrorShieldItem() {
	...
	public void releaseUsing(ItemStack itemstack, Level world, LivingEntity entityLiving, int timeLeft) {
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				MirrorShieldEntity entityarrow = MirrorShieldEntity.shoot(world, entity, world.getRandom(), 1f, 5, 5);
				itemstack.hurtAndBreak(1, entity, e -> e.broadcastBreakEvent(entity.getUsedItemHand()));
				entityarrow.pickup = AbstractArrow.Pickup.DISALLOWED;
				UseMirrorShieldProcedure.execute();
			}
		}
	}
}
