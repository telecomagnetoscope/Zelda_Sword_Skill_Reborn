...
public class QuestMenuScreen extends AbstractContainerScreen<QuestMenuMenu> {
	...
	private static final ResourceLocation texture = new ResourceLocation("zelda_sword_skill_reborn:textures/screens/quest_menu.png");
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, Component.translatable("gui.zelda_sword_skill_reborn.quest_menu.label_quest_status"), 11, 8, -12829636);
	}
