 ...
 *
 */
package net.mcreator.zeldaswordskillreborn;
...
@Mod("zelda_sword_skill_reborn")
public class ZeldaSwordSkillRebornMod {
	public static final Logger LOGGER = LogManager.getLogger(ZeldaSwordSkillRebornMod.class);
	public static final String MODID = "zelda_sword_skill_reborn";

	public ZeldaSwordSkillRebornMod() {
