...
public class OcarinaGuiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public OcarinaGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ZeldaSwordSkillRebornModMenus.OCARINA_GUI.get(), id);
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 7, 26) {
			...
			public boolean mayPlace(ItemStack stack) {
				return ZeldaSwordSkillRebornModItems.ZELDAS_LULLABY.get() == stack.getItem();
			}
		}));
		this.customSlots.put(1, this.addSlot(new SlotItemHandler(internal, 1, 34, 26) {
			@Override
			public boolean mayPlace(ItemStack stack) {
				return ZeldaSwordSkillRebornModItems.SUNSSONG.get() == stack.getItem();
			}
		}));
		this.customSlots.put(2, this.addSlot(new SlotItemHandler(internal, 2, 61, 26) {
			@Override
			public boolean mayPlace(ItemStack stack) {
				return ZeldaSwordSkillRebornModItems.SARIASSONG.get() == stack.getItem();
			}
		}));
		this.customSlots.put(3, this.addSlot(new SlotItemHandler(internal, 3, 97, 26) {
			@Override
			public boolean mayPlace(ItemStack stack) {
				return ZeldaSwordSkillRebornModItems.EPONASONG.get() == stack.getItem();
			}
		}));
		this.customSlots.put(4, this.addSlot(new SlotItemHandler(internal, 4, 124, 26) {
			@Override
			public boolean mayPlace(ItemStack stack) {
				return ZeldaSwordSkillRebornModItems.SONG_OF_TIME.get() == stack.getItem();
			}
		}));
		this.customSlots.put(5, this.addSlot(new SlotItemHandler(internal, 5, 151, 26) {
			@Override
			public boolean mayPlace(ItemStack stack) {
				return ZeldaSwordSkillRebornModItems.SONGOF_STORM.get() == stack.getItem();
			}
		}));
		this.customSlots.put(6, this.addSlot(new SlotItemHandler(internal, 6, 7, 53) {
			@Override
			public boolean mayPlace(ItemStack stack) {
				return ZeldaSwordSkillRebornModItems.MINUETOF_FOREST.get() == stack.getItem();
			}
		}));
		this.customSlots.put(7, this.addSlot(new SlotItemHandler(internal, 7, 34, 53) {
			@Override
			public boolean mayPlace(ItemStack stack) {
				return ZeldaSwordSkillRebornModItems.BOLEROOF_FIRE.get() == stack.getItem();
			}
		}));
		this.customSlots.put(8, this.addSlot(new SlotItemHandler(internal, 8, 61, 53) {
			@Override
			public boolean mayPlace(ItemStack stack) {
				return ZeldaSwordSkillRebornModItems.SERENADEOF_WATER.get() == stack.getItem();
			}
		}));
		this.customSlots.put(9, this.addSlot(new SlotItemHandler(internal, 9, 97, 53) {
			@Override
			public boolean mayPlace(ItemStack stack) {
				return ZeldaSwordSkillRebornModItems.NOCTURNEOF_SHADOW.get() == stack.getItem();
			}
		}));
		this.customSlots.put(10, this.addSlot(new SlotItemHandler(internal, 10, 124, 53) {
			@Override
			public boolean mayPlace(ItemStack stack) {
				return ZeldaSwordSkillRebornModItems.REQUIEMOF_SPIRITS.get() == stack.getItem();
			}
		}));
		this.customSlots.put(11, this.addSlot(new SlotItemHandler(internal, 11, 151, 53) {
			@Override
			public boolean mayPlace(ItemStack stack) {
				return ZeldaSwordSkillRebornModItems.PRELUDEOF_LIGHT.get() == stack.getItem();
			}
		}));
