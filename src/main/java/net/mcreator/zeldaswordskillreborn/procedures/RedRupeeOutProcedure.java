...
public class RedRupeeOutProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		if (entity == null)
			return;
		if (ZeldaSwordSkillRebornModVariables.MapVariables.get(world).Rupee >= 20) {
			if (entity instanceof ServerPlayer _player && _player.containerMenu instanceof Supplier _current && _current.get() instanceof Map _slots) {
				ItemStack _setstack = new ItemStack(ZeldaSwordSkillRebornModItems.RED_RUPEE.get());
