...
public class GreenRupeeOutProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		if (entity == null)
			return;
		if (ZeldaSwordSkillRebornModVariables.MapVariables.get(world).Rupee >= 1) {
			if (entity instanceof ServerPlayer _player && _player.containerMenu instanceof Supplier _current && _current.get() instanceof Map _slots) {
				ItemStack _setstack = new ItemStack(ZeldaSwordSkillRebornModItems.GREEN_RUPEE.get());
